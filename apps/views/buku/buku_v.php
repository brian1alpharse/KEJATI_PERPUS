...
<div class="box box-info box-solid">
  ...
  <div class="box-body">
    <div style="text-align:right; margin-top:10px; margin-bottom: 10px;">
        <button class="btn btn-warning btn-import" ><i class="fa fa-cloud-upload fa-fw"></i> Buku Baru</button>
    </div>
		<table class="table table-hover" id="table">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $r->statussedia ?></td>
					<td><?php echo $r->jumlahbuku ?></td>
					<td>
						<a href="javascript:;" class="btn btn-primary btn-xs btn-update" data-id="<?php echo $r->kodebuku ?>"> <i class="fa fa-edit fa-fw" style="color:#ffffff;"></i> <span style="color:#ffffff;">Ubah</span></a>
						<a href="javascript:;" class="btn btn-danger btn-xs hapus-data" data-toggle="modal" data-target="#konfirmasiHapus" data-id="<?php echo $r->kodebuku ?>"><i class="fa fa-trash fa-fw" style="color:#ffffff;"></i>  <span style="color:#ffffff;">Hapus</span></a>
					</td>
				</tr>
				<?php } ?>
			</tbody>
...
<div class="modal fade" id="konfirmasiHapus" role="dialog">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
        ...
        <form method="post" action="<?php echo base_url() ?>Master/hapusbuku">
...
<script type="text/javascript">
	...
	$(document).on("click", ".btn-import", function() {
	  ...
	  $.ajax({
	    method: "POST",
	    url: "<?php echo base_url('Master/inputbuku'); ?>",
	    data: "id=" +id
	  })
	  .done(function(data) {
	...
	$(document).on("click", ".btn-update", function() {
	  ...
	  $.ajax({
	    method: "POST",
	    url: "<?php echo base_url('Master/ubahbuku'); ?>",
	    data: "id=" +id
	  })
	  .done(function(data) {
	    $('#tempat-modal').html(data);        
